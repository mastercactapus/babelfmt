...
declare class BabelNodeFunctionDeclaration extends BabelNode {
  ...
  generator?: boolean;
  async?: boolean;
  returnType: ?BabelNodeTypeAnnotation;
...
declare class BabelNodeObjectExpression extends BabelNode {
  ...
  properties: Array<BabelNodeObjectMethod|BabelNodeObjectProperty|BabelNodeSpreadProperty>;
}
...
declare class BabelNodeClassDeclaration extends BabelNode {
  ...
  decorators: Array<BabelNodeDecorator>;
  typeParameters: BabelNodeTypeAnnotation;
  superTypeParameters: BabelNodeTypeAnnotation;
}
...
declare class BabelNodeImportDeclaration extends BabelNode {
  ...
  specifiers: Array<BabelNodeImportDefaultSpecifier|BabelNodeImportSpecifier|BabelNodeImportNamespaceSpecifier>;
  source: BabelNodeStringLiteral;
}
...
declare class BabelNodeClassProperty extends BabelNode {
  ...
  value: any;
  typeAnnotation: BabelNodeTypeAnnotation;
  decorators?: Array<BabelNodeTypeAnnotation>;
}
...
declare class BabelNodeObjectTypeAnnotation extends BabelNode {
  ...
  properties: array<BabelNodeTypeAnnotation>;
  indexers: array<BabelNodeTypeAnnotation>;
  callProperties: array<BabelNodeTypeAnnotation>;
}
...
declare class BabelNodeJSXElement extends BabelNode {
  ...
  children: Array<BabelNodeStringLiteral|BabelNodeJSXExpressionContainer|BabelNodeJSXElement>;
}
